    ...
    <div className="min-h-screen bg-gradient-to-br from-red-700 via-red-800 to-red-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 slide-up">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join Campus Connect!</h2>
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-700 focus:border-transparent transition-all">
          ...
          <div className="flex items-start">
            <input type="checkbox" className="mt-1 rounded border-gray-300 text-red-700 focus:ring-red-700" />
            <label className="ml-2 text-sm text-gray-600">
              I agree to the <a href="#" className="text-red-700 hover:text-red-800">Terms of Service</a> and{' '}
              <a href="#" className="text-red-700 hover:text-red-800">Privacy Policy</a>
            </label>
          </div>
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <button type="button" onClick={() => setCurrentPage('login')} className="text-red-700 hover:text-red-800 font-medium">
              Sign in
            </button>
          </p>
        </form>
